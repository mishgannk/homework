function makeNote(note_obj) {
    ...
    buttonDelete.classList.add('note-button-delete')
    let imageButtonDelete = document.createElement('img')
    imageButtonDelete.src = 'delete.png'
    imageButtonDelete.classList.add('note-button-edit')
    buttonDelete.appendChild(imageButtonDelete)

    let buttonEdit = document.createElement('button')
    //  buttonEdit.classList.add('note-button-edit')
    let imageButtonEdit = document.createElement('img')
    imageButtonEdit.src = 'edit.png'
    imageButtonEdit.classList.add('note-button-edit')
    buttonEdit.appendChild(imageButtonEdit)
